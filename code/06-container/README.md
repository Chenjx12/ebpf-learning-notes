...
**对应笔记**: [Six、容器感知与身份识别：从内核到云原生](../docs/Six、容器感知与身份识别：从内核到云原生.md)
...
- **学习笔记**: [Six、容器感知与身份识别：从内核到云原生](../docs/Six、容器感知与身份识别：从内核到云原生.md)
- **第五篇笔记**: [Five、eBPF 程序的拆分与组合](../docs/Five、eBPF%20程序的拆分与组合.md) (前置知识)
